	...
	static {
		...
		articles = new ArrayList<Article>(Arrays.asList(new Article[] {
				new Article(0, StaticUserServiceImpl.users.get(0), "First Article",
						"/img/thumbnails/fallon-michael-kx7Ou-9xy0E-unsplash.jpg", content, new Date()),
				new Article(1, StaticUserServiceImpl.users.get(0), "Second Article",
						"/img/thumbnails/hussain-faruhaan-XOEL0hNDub0-unsplash.jpg", content, new Date()),
				new Article(2, StaticUserServiceImpl.users.get(1), "Third Article",
						"/img/thumbnails/motoki-tonn-vV1a1Leq-dQ-unsplash.jpg", content, new Date()),
				new Article(3, StaticUserServiceImpl.users.get(1), "Fourth Article",
						"/img/thumbnails/patrick-hendry-A9tqKShumpM-unsplash.jpg", content, new Date()),
				new Article(4, StaticUserServiceImpl.users.get(2), "Fifth Article",
						"/img/thumbnails/person-climbing-staircase-between-escalators-3429166.jpg", content,
						new Date()),
				new Article(5, StaticUserServiceImpl.users.get(2), "Sixth Article",
						"/img/thumbnails/thomas-bonometti-mx6BzzKvWIw-unsplash.jpg", content, new Date()), }));
	}
